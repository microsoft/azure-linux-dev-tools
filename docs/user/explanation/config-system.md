...
1. **Project-level defaults** — the `default-component-config` defined at the project root
2. **Distro version defaults** — the `default-component-config` defined in the distro version (e.g., `[distros.azurelinux.versions.'4.0'.default-component-config]`)
