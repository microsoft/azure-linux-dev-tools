...
To get started developing `azldev`, review the [Getting Started guide](./how-to/get-started.md).

## How tos

* [Get started](./how-to/get-started.md)
* [Dev workflow](./how-to/dev-workflow.md)
...
* [Package azldev for Fedora COPR](./how-to/package-for-copr.md)

## Reference

* [Build reference](./reference/build.md)
* [Coding standards](./reference/coding-standards.md)
* [Command guidelines](./reference/command-guidelines.md)
